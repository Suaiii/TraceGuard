...
| 提交包装配脚本与工作包 | `scripts/build_submission_package.ps1`、`output/submission/TraceGuard_submission_working_20260713_210646/` | 提交工具/本地工作包 | 从 Git 跟踪源码、本地报告和正式权重生成 | tracked + ignored/local | 已装配程序、四份材料、正式权重和 SHA-256 清单；从包内启动 CUDA 服务后健康接口返回 200、`model_loaded=true`，明确标记为未封版 |
